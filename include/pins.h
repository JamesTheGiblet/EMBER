...
namespace Pins {
    ...
    constexpr int MOTOR_A_IN2 = 2;  // Left Motor IN2 (TB6612: AIN2)
    constexpr int MOTOR_B_IN1 = 16; // Right Motor IN1 (TB6612: BIN1)
    constexpr int MOTOR_B_IN2 = 17; // Right Motor IN2 (TB6612: BIN2)
